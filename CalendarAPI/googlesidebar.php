...
$client->setDeveloperKey('AIzaSyCYdOoUhuVRi018qLx7rrgpRfOlTYzPD68'); //GET AT AT DEVELOPERS.GOOGLE.COM
...
?>">
        ...
        <?php echo "Summary : ">$event->summary; //SUMMARY = TITLE
